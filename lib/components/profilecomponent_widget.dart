      ...
      child: Stack(
        children: [
          ...
          Align(
            ...
            child: Padding(
              padding:
                  const EdgeInsetsDirectional.fromSTEB(600.0, 300.0, 400.0, 450.0),
              child: Row(
                mainAxisSize: MainAxisSize.max,
                mainAxisAlignment: MainAxisAlignment.start,
                children: [
          ...
          Align(
            ...
            child: Padding(
              padding:
                  const EdgeInsetsDirectional.fromSTEB(600.0, 380.0, 400.0, 450.0),
              child: Row(
                mainAxisSize: MainAxisSize.max,
                mainAxisAlignment: MainAxisAlignment.start,
                children: [
          ...
          Padding(
            padding: const EdgeInsetsDirectional.fromSTEB(1200.0, 50.0, 100.0, 500.0),
            child: Row(
              mainAxisSize: MainAxisSize.max,
              children: [
                FFButtonWidget(
          ...
          Align(
            alignment: const AlignmentDirectional(0.0, -0.75),
            child: Padding(
              padding: const EdgeInsetsDirectional.fromSTEB(300.0, 0.0, 1000.0, 0.0),
              child: Row(
                mainAxisSize: MainAxisSize.max,
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
