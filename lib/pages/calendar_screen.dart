          ...
          children: [
            Padding(
              ...
              child: Row(
                ...
                children: [
                  SizedBox(width: 300),
                  _buildIndicatorCircle(Color(0xFFCFE1B9), 'Relaxed Days/Months'),
                  SizedBox(width: 20),
                  _buildIndicatorCircle(Color(0xDDDD8282), 'Stressed Days/Months'),
                  SizedBox(width: 180),
                   Container(
...
Widget _buildMonthlyView() {
  ...
  final random = Random(year); // Use the year as a seed for the random number generator
  ...
  for (int month = 1; month <= 12; month++) {
    final randomColor = Random(month).nextBool() ? color1 : color2;
    ...
    // If the current row has three months or it's the last month
    if (currentRow.length == 3 || month == 12) {
      monthRows.add(
        Row(
          mainAxisAlignment: MainAxisAlignment.center,
      ...
      currentRow.clear(); // Clear the current row
    }
  }
    ...
    Row(
      ...
      children: [
        Padding(
          ...
          child: SizedBox(
            width: 40, // Adjust the width of the SizedBox to control the size of the IconButton
            child: IconButton(
              iconSize: 15, // Adjust the size of the icon
              icon: Icon(Icons.arrow_back_ios), // Use arrow_back_ios icon for the back button
              onPressed: () {
                setState(() {
        ...
        Padding(
          ...
          child: SizedBox(
            ...
            child: IconButton(
              iconSize: 15, // Adjust the size of the icon
              icon: Icon(Icons.arrow_forward_ios), // Use arrow_forward_ios icon for the forward button
              ...
              color: _focusedDay.year == DateTime.now().year ? Colors.grey : null,
            ),
          ),
        ),
      ],
  ...
  Widget _buildDayCell(DateTime day) {
    final randomColor = Random(day.day).nextBool() ? Color(0xFFCFE1B9) : Color(0xDDDD8282);
    return Container(
      decoration: BoxDecoration(
        shape: BoxShape.circle,
        color: randomColor,
