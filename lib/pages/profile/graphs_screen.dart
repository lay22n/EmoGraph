...
class GraphicalRepresentationScreen extends StatefulWidget {
  @override
  _GraphicalRepresentationScreenState createState() =>
      _GraphicalRepresentationScreenState();
}

class _GraphicalRepresentationScreenState
    extends State<GraphicalRepresentationScreen> {
  ...
  List<PieChartSectionData> pieChartDataSections =
...
// Current selected date for the label
  ...
  void _initData() {
    ...
    lineChartDataPoints = [
      FlSpot(0, 3),
      FlSpot(1, 2.5), // ... initial data points for the line chart
    ];
    pieChartDataSections = [
      PieChartSectionData(
          value: 35,
          title: '35%',
          color: Color(0xDDDD8282).withOpacity(0.75),
          radius: 50),
      PieChartSectionData(
          value: 25, title: '25%', color: Color(0xFF7AC7FF), radius: 50),
      PieChartSectionData(
          value: 40, title: '40%', color: Color(0xFFCFE1B9), radius: 50),
    ];
  }
    ...
    if (index == 0) {
      ...
      pieChartDataSections = [
        PieChartSectionData(
            ...
            radius: 50),
        PieChartSectionData(
            value: 30, title: '30%', color: Color(0xFF7AC7FF), radius: 50),
        PieChartSectionData(
            value: 50, title: '50%', color: Color(0xFFCFE1B9), radius: 50),
      ];
    } else if (index == 1) {
      // Monthly
      pieChartDataSections = [
        PieChartSectionData(
            ...
            radius: 50),
        PieChartSectionData(
            value: 35, title: '35%', color: Color(0xFF7AC7FF), radius: 50),
        PieChartSectionData(
            value: 40, title: '40%', color: Color(0xFFCFE1B9), radius: 50),
      ];
    } else if (index == 2) {
      ...
      pieChartDataSections = [
        ...
        PieChartSectionData(
            value: 25, title: '25%', color: Color(0xFF7AC7FF), radius: 50),
        PieChartSectionData(
            value: 60, title: '60%', color: Color(0xFFCFE1B9), radius: 50),
      ];
    }
  ...
  LineChartData _mainChartData() {
    ...
    return LineChartData(
      ...
      lineBarsData: [
        LineChartBarData(
          spots: lineChartDataPoints, // Use dynamic data here
          ...
          children: [
            ...
            Container(
              ...
              child: ToggleButtons(
                  ...
                  fillColor:
                      Color(0xFFBC6C25), // Background color when selected
                  children: <Widget>[
                    Padding(
                ...
                children: <Widget>[
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text(
                          'Check out these ideas to improve employee emotions!'),
